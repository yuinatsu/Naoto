...
bool AnimationLoder::LoadAnimTmx(const std::string& filepath)
{
	...
	for (rapidxml::xml_node<>* animNode = tmx_orign_node_->first_node("char")->first_node("move");animNode != nullptr && animid != Char_Anim_ID::MAX; animNode = animNode->next_sibling())
	{
